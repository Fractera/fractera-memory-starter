...
🛑 These three are your HANDS, not verbs of the contract. The public API has three verbs — remember,
recall, feedback (207-5): a caller keeps a thing with remember and finds it with recall. Never offer
these names outward.
```
...
Finding a passage by meaning inside all documents is the vector store's job; reading falls to it by
itself when relations find nothing, and you may call it directly.
