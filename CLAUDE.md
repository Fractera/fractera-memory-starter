...
ящика, принимает фразу и возвращает объект. Его инструкция лежит в `AGENT.md` — это **предмет твоей
работы**, а не описание тебя. Прочитав её как своё задание, ты начнёшь отвечать на вопросы о фактах
...
| инструкция агента памяти — предмет работы | `AGENT.md` |
...
утверждает или меняет → и только потом строка в `AGENT.md` и код. Не наоборот.
