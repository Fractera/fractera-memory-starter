...
export function readStep(kind, raw) {
  ...
  const path = inFolder
    ? `development-docs/development-steps/${base}/${step.n}/`
    : `development-docs/development-steps/${base}/${step.n}-*.md`
...
export function readSkill(raw) {
  ...
  return text === null ? null : { path: `.claude/skills/${name}/SKILL.md`, text, title: name }
}
...
export function docFor(raw) {
  ...
  if (value === "current") {
    ...
    return text === null ? null : { path: "development-docs/development-steps/current-steps.md", text, title: "current-steps.md" }
  }
