...
export const OBJECT_NEAR = 0.28;
// 🛑 ЭТО ЧИСЛО ВЕКТОРНОГО КОРПУСА, ВЗЯТОЕ ВРЕМЕННО, И ОНО ПЕРЕМЕРЯЕТСЯ В 192-2.
// Порог — свойство корпуса, а не склада (закон 189-6): карточка объекта длиннее
// и разнороднее абзаца, и шкала у неё своя.
