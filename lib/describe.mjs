...
- "full": a description detailed enough that another AI could RECONSTRUCT the object from it alone.
  ...
  For a web page snapshot (what a real browser extracted from an address): what the page or web app is FOR, its
  structure (navigation, sections), its full visible content, every interactive element (forms, fields, buttons —
  what each does), the media it shows judged by their attributes, and its address. Never claim to have seen
  pixels: you read the extracted text and attributes.
