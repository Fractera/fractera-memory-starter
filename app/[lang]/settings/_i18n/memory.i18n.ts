...
const EN: MemoryUi = {
  ...
  linkBench: {
    ...
    save: {
      ...
      htmlWhole: "Keep the whole page: all its text and the final HTML (for a close copy of the site)",
...
const RU: MemoryUi = {
  ...
  linkBench: {
    ...
    save: {
      ...
      htmlWhole: "Сохранить страницу целиком: весь её текст и итоговый HTML (для близкой копии сайта)",
