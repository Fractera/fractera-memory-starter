...
// спрашивал у записи только про два органа, а у вопроса — только про пять.
// 🪦 206-6: из списка ушли `deny`, `need_table`, `history`, `prior`, `thread` — их сняли с входа
// решением владельца (206-9). Прибор проверяет ТО ЖЕ правило на живых органах: выставленное
// либо в теле, либо названо непринятым. Прогон до перенацеливания: 12 провалов.
//
...
const CONTROLS = ["depth", "want_chain", "scope"]
