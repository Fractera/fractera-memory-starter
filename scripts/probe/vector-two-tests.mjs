...
const A = [
  { about: "часы", q: "кто чинит старые механизмы с маятником" },
  { about: "стекло", q: "где делают колбы для опытов" },
  { about: "кедр", q: "кто разводит ёлки для скверов" },
  { about: "пекарня", q: "где пекут на живой опаре" },
